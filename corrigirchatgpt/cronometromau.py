...
#Isso provavelmente foi causado pelo motivo de não dar para parar o cronometro no meio da contagem, então ele tentou achar outra forma de fazer o código
import time
